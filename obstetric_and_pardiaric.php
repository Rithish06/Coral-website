...
<head>
  ...
  <meta name="title" content=" Obstetric & Pediatric Care - Coral Advanced Fertility">
  <meta name=description content="Coral Advanced Fertility provides comprehensive obstetric and pediatric care, supporting you through pregnancy and beyond.">
  <meta name="keywords" content="obstetric care Bangalore, pediatric care, Coral Fertility, pregnancy care">
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,900;1,100;1,200;1,300;1,400;1,700&display=swap" rel="stylesheet">
  ...
  <title> Obstetric & Pediatric Care - Coral Advanced Fertility</title>
...
<script>
  ...
  <img class="new_construction_gif" src="https://coraladvancedfertility.com/assets/img/obstetric_banner.jpg" alt="">
...
<section class="ivf_page">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>What is Obstetric & Pediatric Care?</h1>
                <p>Obstetric & Pediatric Care encompasses a wide range of services, including prenatal care, childbirth support, and postnatal care for expectant parents and their newborns. This holistic approach ensures that both mothers and babies receive the specialized attention and care they need during pregnancy and beyond. These services encompass:</p>
                <h1>The Obstetric & Pediatric Process.</h1>
                <ul>
                    <li>Prenatal Care</li>
                    <p>Our dedicated team of obstetricians and midwives provides comprehensive prenatal care, including regular check-ups, ultrasound scans, and expert guidance to monitor your baby's growth and your own health throughout pregnancy. This care is designed to keep both mother and baby healthy and well-informed.</p>
                    <li>Childbirth Support</li>
                    <p>During labor and delivery, our experienced obstetricians and nursing staff provide guidance, pain management options, and support, ensuring a safe and comfortable birthing experience. We cater to your individual preferences, whether you choose a natural birth, a C-section, or other birthing options.</p>
                    <li>Postnatal Care</li>
                    <p>After your baby arrives, our pediatricians and postnatal care specialists provide guidance on infant care, including feeding, sleep routines, and essential health check-ups. This ongoing support ensures that your baby continues to thrive in the critical early stages of life.</p>
                </ul>

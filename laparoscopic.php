...
<head>
  ...
  <meta name="title" content="Laparoscopic Surgery for Fertility - Coral Advanced Fertility">
  <meta name="description" content="Coral Advanced Fertility provides advanced laparoscopic surgery, offering minimally invasive treatments to improve fertility.">
  <meta name="keywords" content="laparoscopic surgery Bangalore, fertility surgery, Coral Fertility, minimally invasive surgery">
...
<script>
  ...
  <img class="new_construction_gif" src="https://coraladvancedfertility.com/assets/img/laparoscopic_banner.jpg" alt="">
...
<section class="ivf_page">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>What is Laproscopic Surgery?</h1>
                <p>Laproscopic surgery is a minimally invasive surgical technique that utilizes small incisions and specialized instruments to access and treat various reproductive and gynecological conditions. This approach allows for precise diagnosis and treatment with reduced pain, faster recovery, and minimal scarring. Laproscopic surgery is often used to address conditions such as endometriosis, uterine fibroids, ovarian cysts, and tubal disorders that may be contributing to infertility.</p>
                <h1>The Laproscopic Surgery Process:</h1>
                <ul>
                    <li>Consultation</li>
                    <p>Your journey begins with a comprehensive consultation with our surgical team. During this discussion, your medical history, fertility challenges, and the potential need for laproscopic surgery are thoroughly assessed.</p>
                    <li>Preparation</li>
                    <p>Prior to the procedure, you'll be given instructions for pre-operative preparations. You may need to fast for a certain period and refrain from taking specific medications, depending on your individual case.</p>
                    <li>Surgery</li>
                    <p>The laparoscope is inserted through one of the incisions, allowing the surgical team to visualize the internal structures of the pelvis and abdomen on a monitor. Additional instruments are inserted through the other incisions to perform the necessary surgical tasks.</p>
                    <li>Treatment</li>
                    <p>Depending on the condition being addressed, the surgeon will perform the necessary procedures. This may involve removing ovarian cysts, excising endometriosis lesions, repairing fallopian tubes, or treating uterine fibroids, among other interventions.</p>
                    <li>Closure</li>
                    <p>Once the procedure is complete, the incisions are closed with sutures or adhesive strips. These small incisions significantly reduce the risk of infection and result in minimal scarring.</p>
                    <li>Recovery</li>
                    <p>After laproscopic surgery, the recovery time is generally shorter compared to traditional open surgery. Most patients can return to their normal activities within a few days to weeks, depending on the extent of the procedure.</p>
                </ul>
...
<!-- <section class="why_choose_section">
    <div class="container">
        <h1>The Obstetric & Pediatric Care Process:</h1>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                <div class="card-body">
                        <h4>Prenatal Consultation</h4>
                        <p>Your journey begins with a prenatal consultation. During this visit, we'll discuss your health, medical history, and any specific concerns you may have. We'll outline a personalized prenatal care plan to ensure a healthy pregnancy.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h4>Regular Prenatal Check-ups</h4> 
                        <p>Throughout your pregnancy, you'll attend regular check-ups. These appointments include monitoring your health and the development of your baby, along with any necessary tests and ultrasounds.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h4>Childbirth Preparation</h4>
                        <p>As your due date approaches, we'll provide childbirth preparation classes, ensuring that you are informed and prepared for labor and delivery. We'll also discuss your birthing preferences and create a birth plan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mt-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>When labor begins, our team is ready to provide expert support and care. We'll help you manage pain, monitor your baby's progress, and ensure a safe delivery experience.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mt-md-3 mb-md-3">
                <div class="card">
                    <div class="card-body">
                        <h4>Postnatal Support</h4>
                        <p>After your baby is born, our pediatricians will conduct newborn examinations and offer guidance on infant care, feeding, and sleeping routines. We're here to support you during the crucial early days of parenthood.</p>
                    </div>
                </div>  
            </div>
            <div class="col-md-2"></div>

...
<head>
  ...
  <meta name="title" content=" Andrology Services - Coral Advanced Fertility">
  <meta name="description" content="Comprehensive andrology services at Coral Advanced Fertility include male fertility testing and treatments for male infertility.">
  <meta name="keywords" content="Preimplantation Genetic Testing, Preimplantation Genetic Diagnosis, PGT, PGD, Coral Advanced Fertility,andrology services Bangalore, male infertility, Coral Fertility, male fertility testing">
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,900;1,100;1,200;1,300;1,400;1,700&display=swap" rel="stylesheet">
  ...
  <title> Andrology Services - Coral Advanced Fertility</title>
...
<script>
  ...
  <img class="new_construction_gif" src="https://coraladvancedfertility.com/assets/img/andrology_banner.jpg" alt="">
...
<section class="ivf_page">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>What is PESA and TESA?</h1>
                <p>PESA and TESA are specialized techniques that are crucial for couples struggling with male infertility. These procedures are designed to retrieve viable sperm for use in assisted reproductive technologies such as Intrauterine Insemination (IUI) or In Vitro Fertilization (IVF) when natural sperm production, delivery, or quality is impaired.</p>
                <h1>The PESA and TESA Process:</h1>
                <ul>
                    <li>Consultation</li>
                    <p>Your journey begins with a comprehensive consultation with our expert andrologists who will assess your specific fertility concerns and recommend PESA or TESA if necessary.</p>
                    <li>Procedure Preparation</li>
                    <p>On the day of the procedure, you will be prepared for either PESA or TESA, based on your unique needs. The choice between the two procedures is determined by your specific diagnosis and medical history.</p>
                    <li>Sperm Retrieval</li>
                    <p>During the procedure, sperm is collected using a fine needle for PESA or through a small tissue biopsy for TESA. The collected sperm is then processed and evaluated in the laboratory.</p>
                    <li>Fertility Treatment</li>
                    <p>The obtained sperm is typically used immediately for the intended fertility treatment, whether it be IUI or IVF, to maximise the chances of conception.</p>
                    <li>Post-Procedure Care</li>
                    <p>After the procedure, you may experience mild discomfort, but recovery is generally quick and uncomplicated.</p>
                </ul>
...
<section class="why_choose_section">
    <div class="container">
        <h1>How Can PESA and TESA Help You?</h1>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                <div class="card-body">
                        <h4>Minimally Invasive</h4>
                        <p>Both PESA and TESA are minimally invasive procedures, resulting in minimal discomfort and a quick recovery.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h4>Achieve Pregnancy</h4> 
                        <p>procedures increase the chances of conception when natural conception is not possible due to male factor infertility</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>PESA and TESA are tailored to your specific diagnosis, ensuring the most appropriate treatment is used</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mt-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4>Overcome Male Infertility</h4>
                        <p>PESA and TESA offer hope to couples struggling with male infertility by providing access to viable sperm for assisted reproductive treatments.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mt-md-3 mb-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Our experienced andrology team is dedicated to providing the highest level of care and support throughout the process for all treatments.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-2"></div>

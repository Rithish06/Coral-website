...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,900;1,100;1,200;1,300;1,400;1,700&display=swap" rel="stylesheet">
  ...
  <title>Contact Coral Advanced Fertility - Book Your Consultation</title>
...
<script>
  ...
  </section><!-- <section class="construction_seprate_services">
    <div class="container">
        <div class="row">
            <div class="col-md-6 construction_service_subpage">
                <h4>Contact<span class="construction_span_style">&nbsp;Us</span></h4>
                <p>Feel free to contact us for all your construction related requirements</p>
            </div>
            <div class="col-md-6">
                <img class="new_construction_gif" src="https://coraladvancedfertility.com/assets/img/contact_us.gif" alt="">
            </div>
        </div>
    </div>
</section> -->
...
<section>
  <img class="new_construction_gif" src="https://coraladvancedfertility.com/assets/img/contact_banner.jpg" alt="">
...
<section id="contact" class="contact new_contactus">
  <div class="container">

    <!-- <div class="section-title">
          <p>Feel free to get in tdouch by phone or through the contact form below. Your message will be send directly to our staff who will answer as soon as they can.</p>
        </div> -->
    ...
    <div class="row">
      ...
      <div class="col-lg-5 d-flex align-items-stretch">
        <div class="info">
          <div class="address">
            ...
            <h4>Location: <p>#1/1, 4th floor, above ICICI Bank, NEW BEL Road, R.M.V. 2nd Stage Bengaluru-560094</p>
            </h4>
            <!-- <p></p> -->
          </div>
          ...
          <div class="email">
            ...
            <h4>Email:<p>info@coraladvancedfertility.com</p>
            </h4>
      ...
      <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
        <form method="post" action="https://coraladvancedfertility.com/sendMail" role="form" class="php-email-form">
          ...
          <div class="form-group ">
            <input type="text" class="form-control  mobile" id="mobile" name="mobile" placeholder="Enter Your Mobile Number" required="" pattern="[6-9]{1}[0-9]{9}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control selectPest" name="services" id="exampleFormControlSelect1">
              <option>Select Service</option>
<option>Male & Female Evaluation</option>
<option>OI</option>
<option>IUI</option>
<option>IVF, ICSI, IMSI</option>
<option>Fertility Preservation</option>
<option>PGT | PGD</option>
<option>Androloy</option>
<option>Fetal Medicine Scans</option>
<option>Obstetric & Pediatric Care</option>
<option>Enhancing Surgeries</option>
<option>Laproscopic Surgery</option>
<option>Hysteroscopic Surgery</option>
<option>Vaginal Rejuvenation</option>
<option>Menopausal</option>
<option>Cosmetic Gynecology</option>
<option>Adolescent Gynecology</option>
<option>General Surgery</option>
<option>Women's Health Checkup</option>
            </select>
          </div>
          <div class="mb-3">
          ...
          <div class="text-center"><button type="submit" class="form_enquire_btn">Send Message</button></div>
        </form>
      </div>
    </div>
...
<section class="container">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15547.798595385178!2d77.56474!3d13.038877!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17f1ed8e9581%3A0x2969524e63415fb7!2sCORAL%20Advanced%20fertility%20And%20Women&#39;s%20care!5e0!3m2!1sen!2sin!4v1697027153777!5m2!1sen!2sin" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </section>

...
<head>
  ...
  <meta name="title" content="About Coral Advanced Fertility Center - Expert Fertility Care">
  <meta name="description" content=" Learn about Coral Advanced Fertility Center, your expert fertility care provider in Bangalore, dedicated to your reproductive health.">
  <meta name="keywords" content="Coral Advanced Fertility Center, Fertility Care, Fertility Center, Fertility Clinic, Fertility Specialist, Fertility Doctor, Fertility Treatment, Fertility Hospital, Fertility Services, Fertility Care Provider, Fertility Care Center, Fertility Care Clinic, Fertility Care Specialist, Fertility Care Doctor, Fertility Care Treatment, Fertility Care Hospital, Fertility Care Services, Fertility Care Provider in Bangalore, Fertility Care Center in Bangalore, Fertility Care Clinic in Bangalore, Fertility Care Specialist in Bangalore, Fertility Care Doctor in Bangalore, Fertility Care Treatment in Bangalore, Fertility Care Hospital in Bangalore, Fertility Care Services in Bangalore">
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,900;1,100;1,200;1,300;1,400;1,700&display=swap" rel="stylesheet">
  ...
  <title>About Coral Advanced Fertility Center - Expert Fertility Care</title>
...
<script>
  ...
  <img class="new_construction_gif" src="https://coraladvancedfertility.com/assets/img/aboutus_banner.jpg" alt="">

</section>

<section class="icons_details_imp">
    <div class="container">
      <div class="row">
        <div class="col-md-2 m-auto">
          <div class="doctor_det m-auto">
          <img src="https://coraladvancedfertility.com/assets/img/doctor_interest.png" alt="">
          </div>
          <h5>20+ years</h5>
          <p>Experience</p>
        </div>
        <div class="col-md-2 m-auto">
          <div class="doctor_det m-auto">
          <img src="https://coraladvancedfertility.com/assets/img/excellence.png" alt="">
          </div>
          <h5>High</h5>
          <p>Success Rate</p>
        </div>
        <div class="col-md-2 m-auto">
          <div class="doctor_det m-auto">
          <img src="https://coraladvancedfertility.com/assets/img/syringe.png" alt="">
          </div>
          <h5>State-of-art</h5>
          <p>Infrastructure</p>
        </div>
        <div class="col-md-2 m-auto">
          <div class="doctor_det m-auto">
          <img src="https://coraladvancedfertility.com/assets/img/wallet.png" alt="">
          </div>
          <h5>Affordable</h5>
          <p>Treatment Cost</p>
        </div>
        <div class="col-md-2 m-auto">
          <div class="doctor_det m-auto">
          <img src="https://coraladvancedfertility.com/assets/img/family.png" alt="">
          </div>
          <h5>6000+</h5>
          <p>Happy Families</p>
        </div>
        <div class="text-center">
              <a href="https://coraladvancedfertility.com/contactus" class="btn btn_touch">Contact Us <img class="touch_details" src="https://coraladvancedfertility.com/assets/img/touch.png" alt=""></a>
            </div>
      </div>
    </div>
</section>

<section class="about_hometheory about_us_next_page">
  <div class="container">
    <!-- <h4 class="shadow">About Us</h4> -->
    <div class="row">
      <div class="col-md-8 m-auto">
        <h3 class="text-center">What we offer</h3>
        <p>"At Advanced Fertility & Maternity Care, we undetstand that journey towards paranethood can be filled with excitement, home, and sometimes Challenges.
          Out Dedicated team of medical professionals is here to provide you with compassion-nate care, advanced fertility treaments, and comprehensive maternity."</p>
         <h3 class="text-center">Our Mission</h3>
          <p>Our mission is to help individuals and couples achieve their dream of starting or expanding their families. We are comitted to providing personalized evidence.</p>
          <div class="text-center">
              <a href="https://coraladvancedfertility.com/contactus" class="btn btn_touch">Contact Us <img class="touch_details" src="https://coraladvancedfertility.com/assets/img/touch.png" alt=""></a>
            </div>
        </div>
      ...
      <div class="col-md-4 m-auto">
        <img class="aboutus_img" src="https://coraladvancedfertility.com/assets/img/motherhood.jpg" alt="">
      </div>
    </div>
  </div>
...
<section class="client_directories">
  <div class="container">
    <h4>Clinical Director</h4>
    <div class="row">
      <div class="col-md-5">
        <img src="https://coraladvancedfertility.com/assets/img/dr_sangethha.png" alt="Card image cap">
      </div>
      <div class="col-md-7 col_about_doctor m-auto">
        <div class="card content_card">
          <div class="card-body">
          <p>Our specialists with more than 15 years of hands-on experience in helping couples achieve their dreams of parenthood. With a deep understanding of the emotional and medical aspects of fertility, our specialist offers a range of cutting-edge treatments, from IVF to advanced diagnostic techniques. Rest assured that your journey towards parenthood is in the hands of an expert who genuinely cares about your well-being.</p>
            <p>At Coral, we understand that the journey to parenthood is deeply personal and often challenging. That's why our team of doctors is committed to providing personalised care that addresses your specific needs and concerns. We work closely with each patient, tailoring treatment plans to ensure the best possible outcomes while offering emotional support throughout the process.</p>
          
            <div class="text-center">
              <a href="https://coraladvancedfertility.com/our_doctor" class="btn btn_touch">know more <img class="touch_details" src="https://coraladvancedfertility.com/assets/img/touch.png" alt=""></a>
            </div>
          </div>
          ...
          <!-- <div class="col-md-3  mt-3 m-auto">
            <div class="card">
              <img src="https://coraladvancedfertility.com/assets/img/madam.png" alt="Card image cap">
              <div class="card-body doctor_details">
                <h5>DR. SANGEETHA M. J</h5>
                <p>MBBS, DNB, DGO, FRM,</p>
